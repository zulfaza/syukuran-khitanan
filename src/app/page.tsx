...
export default function Home({ params }: { params: { group: string, groupName: string } }) {
  ...
  return (
    <section className="bg-[#161d28]">
      ...
      <header className="flex justify-center items-center w-full h-[469px] xl:h-[calc(100vh-50px)] relative">
        <div className="bg-accent opacity-60 bg-[url(/images/03.jpg)] md:bg-[center_70%] bg-cover bg-center w-full h-full absolute z-0" ></div>
